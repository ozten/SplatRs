...
/// Reduce per-workgroup gradients to final per-Gaussian gradients.
///
/// Each workgroup has written gradients for all Gaussians to its own buffer section.
/// This function sums across all workgroups to get the final gradients.
///
/// # Arguments
/// * `workgroup_grads` - Flat array of GradientGPU: [wg0_g0, wg0_g1, ..., wg1_g0, wg1_g1, ...]
/// * `num_workgroups` - Total number of workgroups
/// * `num_gaussians` - Number of Gaussians
///
/// # Performance
/// This is a CPU reduction but very fast (~1-2ms for typical scenes):
